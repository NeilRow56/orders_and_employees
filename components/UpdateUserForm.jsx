...
export default function AddUserForm({ formId, formData, setFormData }){
    ...
    return (
        <form className="grid lg:grid-cols-4 w-full gap-4 " onSubmit={handleSubmit}>
            ...
            <button className="flex justify-center text-md w-2/6 bg-yellow-500 text-white px-4 py-2 border rounded-md hover:bg-gray-50 hover:border-green-500 hover:text-yellow-500">
